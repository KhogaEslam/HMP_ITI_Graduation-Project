        ...
        <div class="col-md-12">
            ...
            <form method="POST" action = "{{action("AdminController@updateCategory", [$cat])}}">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Category name" name="name" value='{{$cat->name}}'>
                    @if ( count($errors))
                ...
                <div class="form-group">
                    <button type="submit" class="form-control btn btn-primary"> Edit category </button>
                </div>
            </form>
