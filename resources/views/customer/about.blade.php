    ...
    <div class="row about">
        <div class="container">
            <div class="col-md-6">
                ...
                <button class="myButton" onclick="window.location.href='{{url('/customer/register')}}';">Create Account</button>
            </div>
    ...
    <div class="row about">
        <div class="container">
            ...
            <div class="center-block buttons">
                ...
                <button class="myButton aboutB" onclick="window.location.href='{{url('/shop/register')}}';">Sell on Gadgetly</button>
            </div>
        </div>
    </div>
@endsection